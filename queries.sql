...
GROUP BY o.first_name, o.last_name, o.id
ORDER BY o.first_name;

--Count the number of cars for each owner and display the average price for each of the cars as integers.--
--Display the owners first_name , last_name, average price and count of vehicles. The first_name should be ordered--
--in descending order. Only display results with more than one vehicle and an average price greater than 10000.--
SELECT o.first_name, o.last_name, ROUND(AVG(v.price)), COUNT(*) FROM owners o
JOIN vehicles v ON o.id = v.owner_id
GROUP BY o.first_name, o.last_name, o.id
